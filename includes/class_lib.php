        ...
        <div class="stinfo">Fathers Name:  '.$_SESSION['father_name'].'</div>
				...
				echo('	<table class="record">
					...
					foreach($_SESSION['sub_id'] as $subject){
						...
						<td>');if($_SESSION['practical_flag'][$i]==1){echo("Practical");}else{echo("Theory");}
						echo ('</td>');
						...
						{						
							if($_SESSION['practical_flag'][$i]==1){
								echo("<td>");$input->display_table("","form-control","number",$_SESSION['sub_id'][$i]."cap_ia","Enter CAP + IA",0,0,60,1,60); //ASLIYAT PATA KARO KI MAXIMUM AUR MINIMUM VALUE KYA AAYEGI						
								echo("</td>");
							}
							else{
								echo("<td>");$input->display_table("","form-control","number",$_SESSION['sub_id'][$i]."cat","Enter CAT",0,0,50,1,50); //ASLIYAT PATA KARO KI MAXIMUM AUR MINIMUM VALUE KYA AAYEGI						
								echo("</td>");
							}
					
							if($_SESSION['practical_flag'][$i]==1){
								echo("<td>");$input->display_table("","form-control","number",$_SESSION['sub_id'][$i]."endsempr","End-Sem Practical Marks",0,0,40,1,40);//ASLIYAT PATA KARO KI MAXIMUM AUR MINIMUM VALUE KYA AAYEGI						
								echo("</td>");
							}
							else{
							
								echo("<td>");$input->display_table("","form-control","number",$_SESSION['sub_id'][$i]."endsemth","End-Sem Theoretical Marks",0,0,50,1,50);//ASLIYAT PATA KARO KI MAXIMUM AUR MINIMUM VALUE KYA AAYEGI						
								echo("</td>");
							}
							echo('</tr>');
							$i++;
							...
							if($_SESSION['practical_flag'][$i]==1){
								echo("<td>");$input->display_table("","form-control","number",$_SESSION['sub_id'][$i]."cap_ia","Enter CAP + IA",0,0,60,0,60); //ASLIYAT PATA KARO KI MAXIMUM AUR MINIMUM VALUE KYA AAYEGI						
								echo("</td>");
							}
							else{
								echo("<td>");$input->display_table("","form-control","number",$_SESSION['sub_id'][$i]."cat","Enter CAT",0,0,50,0,50); //ASLIYAT PATA KARO KI MAXIMUM AUR MINIMUM VALUE KYA AAYEGI						
								echo("</td>");
							}
					
							if($_SESSION['practical_flag'][$i]==1){
								echo("<td>");$input->display_table("","form-control","number",$_SESSION['sub_id'][$i]."endsempr","End-Sem Practical Marks",0,0,40,0,40);//ASLIYAT PATA KARO KI MAXIMUM AUR MINIMUM VALUE KYA AAYEGI						
								echo("</td>");
							}
							else{
							
								echo("<td>");$input->display_table("","form-control","number",$_SESSION['sub_id'][$i]."endsemth","End-Sem Theoretical Marks",0,0,50,0,50);//ASLIYAT PATA KARO KI MAXIMUM AUR MINIMUM VALUE KYA AAYEGI						
								echo("</td>");
							}
							echo('</tr>');
							$i++;
