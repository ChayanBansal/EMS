...
<?php
    ...
    $obj=new head();
    $obj->displayheader();
    $obj->dispmenu(3,["home.php","logout.php","developers.php"],["glyphicon glyphicon-home","glyphicon glyphicon-log-out","glyphicon glyphicon-info-sign"],["Home","Log Out","About Us"]);
