...
--
-- Host: localhost
-- Generation Time: Jul 06, 2018 at 07:01 AM
...
INSERT INTO `atkt_sessions` (`atkt_session_id`, `ac_session_id`) VALUES
(0, 1);
...
INSERT INTO `atkt_subjects` (`atkt_roll_id`, `sub_id`, `done_flag`) VALUES
(3, 2, 0);
...
(1, 4, '2018-07-05 12:51:16', 'CHECKED'),
(2, 4, '2018-07-05 12:51:21', 'CHECKED'),
(3, 4, '2018-07-05 12:51:27', 'CHECKED'),
(4, 4, '2018-07-05 12:51:32', 'CHECKED'),
(5, 4, '2018-07-05 12:51:45', 'CHECKED AND CHANGED');
...
INSERT INTO `edit_tr_request` (`request_id`, `requester`, `roll_id`, `cat_flag`, `end_theory_flag`, `cap_flag`, `end_practical_flag`, `ia_flag`, `ie_flag`, `remarks`, `timestamp`, `status`, `ac_sub_code`) VALUES
(1, 4, 1, 0, 0, 0, 0, 1, 0, 'Fail', '2018-07-05 12:55:26', 1, 1);
...
(1, '2016AB001001', 1, 1, NULL, 0, 0, 0, 1);
...
INSERT INTO `score_atkt` (`atkt_roll_id`, `component_id`, `sub_id`, `marks`, `transaction_id`, `check_id`) VALUES
(3, 5, 2, '10.0000', 12, NULL);
...
('2016AB001001', 'Alpha', 'Beta', 'Gamma', 'Theta', 'Echo', 'Tango', 'M', '8854587457', NULL, 2020, NULL, 1);
...
(1, 1, '50.0000', NULL, '50.0000', NULL, '100.0000', '100.0000', 'O', 10, 2, '20.0000'),
(1, 2, '40.0000', '10.0000', '40.0000', NULL, '90.0000', '90.0000', 'A+', 9, 3, '27.0000');
...
(1, 4, '2018-07-05 12:21:35', 'Full'),
(2, 4, '2018-07-05 12:21:53', 'Done'),
(3, 4, '2018-07-05 12:22:12', 'Done'),
(4, 4, '2018-07-05 12:22:34', 'Done'),
(5, 4, '2018-07-05 12:22:54', 'Done'),
(6, 4, '2018-07-05 12:49:58', 'FEd'),
(7, 4, '2018-07-05 12:50:14', 'FEd'),
(8, 4, '2018-07-05 12:50:29', 'FEd'),
(9, 4, '2018-07-05 12:50:43', 'FEd'),
(10, 4, '2018-07-05 12:50:58', 'FEd'),
(12, 4, '2018-07-05 15:33:48', 'Done');
...
--
ALTER TABLE `atkt_roll_list`
  MODIFY `atkt_roll_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
ALTER TABLE `subjects`
  MODIFY `ac_sub_code` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
