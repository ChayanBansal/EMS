...
--
-- Host: localhost
-- Generation Time: Jul 08, 2018 at 04:48 PM
...
INSERT INTO `atkt_roll_list` (`atkt_roll_id`, `roll_id`, `atkt_session_id`, `serial_no`, `no_prints`) VALUES
(1, 1, 1, NULL, 0),
(2, 2, 1, NULL, 0);
...
INSERT INTO `atkt_sessions` (`atkt_session_id`, `ac_session_id`, `tr_gen_flag`) VALUES
(1, 1, 0);
...
INSERT INTO `atkt_subjects` (`atkt_roll_id`, `sub_id`, `component_id`, `done_flag`) VALUES
(1, 1, 1, 0),
(1, 2, 5, 0),
(2, 3, 1, 0),
(2, 4, 3, 0),
...
(1, 4, '2018-07-06 06:41:13', 'Checked'),
(2, 4, '2018-07-06 06:41:21', 'Checked'),
(3, 4, '2018-07-06 06:41:28', 'Checked'),
(4, 2, '2018-07-06 06:41:28', 'fail 5'),
(5, 2, '2018-07-06 06:45:06', 'a'),
(6, 4, '2018-07-06 06:52:45', 'Failed'),
(7, 2, '2018-07-06 06:52:46', 's'),
(8, 4, '2018-07-06 06:52:53', 'Done'),
(9, 4, '2018-07-06 06:53:00', 'Done'),
(10, 2, '2018-07-06 06:53:20', '4'),
(11, 4, '2018-07-06 07:54:32', 'Changed ATKT'),
(12, 4, '2018-07-06 07:54:45', 'CHECKED');
...
INSERT INTO `exam_month_year` (`session_id`, `month_year`, `type_flag`) VALUES
(1, 'december 2016', 0);
...
(1, '2016ab001010', 1, 1, NULL, 0, 0, 0, 1),
(2, '2016ab001010', 2, 1, NULL, 0, 0, 0, 0);
...
('2016ab001010', 'test', 'test', 'test', 'test', 'test', 'test', 'M', '9090909090', NULL, 2020, NULL, 2);
...
(1, 'BTCS01CC01', 'Test - I', 5, 0, 0, 1),
(2, 'BTCS02CC07', 'Advance Software Engineering', 5, 0, 0, 2);
...
(1, 1, '5.0000', NULL, '50.0000', NULL, '55.0000', '55.0000', 'B', 6, 2, '12.0000'),
(1, 2, '40.0000', '4.0000', '40.0000', NULL, '84.0000', '84.0000', 'A+', 9, 3, '27.0000'),
(2, 3, '4.0000', NULL, '30.0000', NULL, '34.0000', '34.0000', 'F', 0, 0, '0.0000'),
(2, 4, '10.0000', '5.0000', '40.0000', NULL, '55.0000', '55.0000', 'B', 6, 4, '24.0000');
...
(1, 4, '2018-07-06 06:40:24', 'Done'),
(2, 2, '2018-07-06 06:40:30', '4'),
(3, 4, '2018-07-06 06:40:37', 'Done'),
(4, 2, '2018-07-06 06:40:52', '40'),
(5, 4, '2018-07-06 06:40:56', 'Done'),
(6, 4, '2018-07-06 06:51:41', 'Fail'),
(7, 2, '2018-07-06 06:51:49', '1'),
(8, 4, '2018-07-06 06:51:58', 'Done'),
(9, 2, '2018-07-06 06:52:09', '30'),
(10, 4, '2018-07-06 06:52:12', 'Done'),
(11, 4, '2018-07-06 07:53:44', 'Done'),
(12, 4, '2018-07-06 07:54:02', 'Done');
...
--
ALTER TABLE `atkt_roll_list`
  MODIFY `atkt_roll_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT for table `atkt_sessions`
--
ALTER TABLE `atkt_sessions`
  MODIFY `atkt_session_id` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `checking`
  MODIFY `check_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
