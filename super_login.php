...
<body>
    ...
    $obj=new head();
    $obj->displayheader();
    $obj->dispmenu(3,["includes/home.php","/index.php","includes/developers.php"],["glyphicon glyphicon-home","glyphicon glyphicon-log-in","glyphicon glyphicon-info-sign"],["Home","Log In as Operator","About Us"]);
